...
from difang.majiang2.table_statistic.statistic_console import MTableStatisticConsole
from difang.majiang2.table_statistic.statistic_longnet import MTableStatisticLongNet
