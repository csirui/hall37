...
class MTableTileTestFactory(object):
    ...
    def getTableTileTestMgr(cls, playerCount, playMode, runMode):
        ...
        if runMode == MRunMode.LONGNET:
            from difang.majiang2.table_tile.test.table_tile_test_longnet import MTableTileTestLongNet
            return MTableTileTestLongNet(playerCount, playMode)

        from difang.majiang2.table_tile.test.table_tile_test_console import MTableTileTestConsole
