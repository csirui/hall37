...
from freetime.support.logserver.protocol import http
from freetime.support.logserver.protocol import tcp
...
_class_map = {
    "indexer-http": http.IndexHttpChannel,
    "s2a": tcp.WriteTcpRequest
}
