...
def useUserItem(userId, gameId, kindId, userBag):
    ...
    try:
        ...
        ftlog.warn('useUserItem.handleException gameId=', gameId, 'userId=', userId, 'itemId=', kindId, 'errorCode=',
    ...
    if actionName:
        try:
            ...
            ftlog.warn('useUserItem.handleException gameId=', gameId, 'userId=', userId, 'itemId=', kindId,
