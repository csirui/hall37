...
class TYDailyCheckinImpl(TYDailyCheckin):
    ...
    def antiCheatWithTodayTime(self, userId):
        ...
        if ftlog.is_debug():
            ftlog.debug('antiCheatWithTodayTime in daily checkin userId =', userId, ' daysWithRecord = ', dayCount,
        ...
        if ftlog.is_debug():
            ftlog.debug('antiCheatWithTodayTime in daily checkin cheatDays = ', cheatDays, ' cheatGameTime = ',
                        cheatGameTime)
