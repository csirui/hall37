...
def _reloadConf():
    ...
    ftlog.info('hall_exit_remind._reloadConf successed orders=', hall_exit_remind._ordersMap)

    hall_exit_remind._vcConfig = hallconf.getExitRemindVCConf()
    ftlog.info('hall_exit_remind._reloadConf successed _vcConfig=', hall_exit_remind._vcConfig)
