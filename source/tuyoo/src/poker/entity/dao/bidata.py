...
def incrGcoin(rkey, coinKey, detalCount):
    ...
    '''
    return dbbi._incrGcoin(rkey, coinKey, detalCount)
...
def setConnOnLineInfo(serverId, userCount):
    ...
    '''
    return dbbi._setConnOnLineInfo(serverId, userCount)
...
def getConnOnlineUserCount():
    ...
    '''
    return dbbi._getConnOnlineUserCount()
...
def setRoomOnLineInfo(gameId, roomId, userCount, playTableCount, observerCount):
    ...
    '''
    return dbbi._setRoomOnLineInfo(gameId, roomId, userCount, playTableCount, observerCount)
...
def getRoomOnLineUserCount(gameId, withShadowRoomInfo):
    ...
    '''
    return dbbi._getRoomOnLineUserCount(gameId, withShadowRoomInfo)
