...
from poker.entity.game.rooms.group_match_ctrl.const import MatchType, FeesType, \
    GroupingType, StageType, AnimationType, SeatQueuingType, MAX_CARD_COUNT, \
    ScoreCalcType
from poker.entity.game.rooms.group_match_ctrl.exceptions import ConfigException
...
class MatchConfig(object):
    ...
    def __init__(self):
        ...
        self.seatId = None
        self.recordId = None
        self.outAssWait = None
        self.outAssKeepReferCount = None
